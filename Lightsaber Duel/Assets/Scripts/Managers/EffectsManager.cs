...
public class EffectsManager : MonoBehaviour {
    ...
    public void PlayAudio(AudioScriptableObject clip, string key, bool loop = false, float pitch = 1, float spatialBlend = 0, Vector3 audioPosition = default(Vector3))
    {
    ...
    public void StopAudio(string audioSourceKey)
    {
